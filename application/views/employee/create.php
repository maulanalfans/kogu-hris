            ...
            <div class="card-body">
                ...
                <?php if (validation_errors()) : ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Oops!</strong> Terjadi kesalahan pada input data.
                ...
                <?= form_open('karyawan/create', ['method' => 'POST', 'autocomplete' => 'off']) ?>

                <div class="row g-3">
                    <!-- NIP -->
                    <div class="col-md-4">
                        <label class="form-label">NIP</label>
                        <input type="text" class="form-control <?= form_error('nip') ? 'is-invalid' : ''; ?>" name="nip" value="<?= set_value('nip'); ?>" required>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control <?= form_error('name') ? 'is-invalid' : ''; ?>" name="name" value="<?= set_value('name'); ?>" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control <?= form_error('phone_number') ? 'is-invalid' : ''; ?>" name="phone_number" value="<?= set_value('phone_number'); ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="email" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" name="email" value="<?= set_value('email'); ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control <?= form_error('nik_ktp') ? 'is-invalid' : ''; ?>" name="nik_ktp" value="<?= set_value('nik_ktp'); ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control <?= form_error('city') ? 'is-invalid' : ''; ?>" name="city" value="<?= set_value('city'); ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select <?= form_error('position_id') ? 'is-invalid' : ''; ?>" name="position_id" required>
                            ...
                            <?php foreach ($positions as $position) : ?>
                                <option value="<?= $position->id ?>" <?= set_select('position_id', $position->id); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select <?= form_error('division_id') ? 'is-invalid' : ''; ?>" name="division_id" required>
                            ...
                            <?php foreach ($divisions as $division) : ?>
                                <option value="<?= $division->id ?>" <?= set_select('division_id', $division->id); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="education_id">
                            ...
                            <?php foreach ($educations as $education) : ?>
                                <option value="<?= $education->id ?>" <?= set_select('education_id', $education->id); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="religion_id">
                            ...
                            <?php foreach ($religions as $religion) : ?>
                                <option value="<?= $religion->id ?>" <?= set_select('religion_id', $religion->id); ?>>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control" name="join_date" value="<?= set_value('join_date'); ?>">
                    </div>

                    <!-- Kontrak -->
                    <div class="col-md-4">
                        <label class="form-label">Mulai Kontrak</label>
                        <input type="date" class="form-control" name="contract_start" value="<?= set_value('contract_start'); ?>">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Akhir Kontrak</label>
                        <input type="date" class="form-control" name="contract_end" value="<?= set_value('contract_end'); ?>">
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="small">*Harap teliti memberikan role user.</div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary btn-sm lift">Simpan</button>
